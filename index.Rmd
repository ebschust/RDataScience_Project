...
```{r, fig.cap="Figure 3. Animation of graptolite synonymies per year.", fig.height=3, fig.width=6, message=FALSE, warning=FALSE, echo=FALSE}
worldmap=borders("world",colour="gray50",fill="white")
mapWorld=ggplot()+worldmap
...
synGrap_authoryear_expect=mutate(synGrap_authoryear,expected=rep(4,length(synGrap_authoryear[,3])))
chisq.test(rbind(synGrap_authoryear_expect$n,synGrap_authoryear_expect$expected))
```
