...
```{r, fig.cap="Figure 3. Animation of graptolite synonymies per year.", fig.height=3, fig.width=6, message=FALSE, warning=FALSE, echo=FALSE,fig.show="animate"}
worldmap=borders("world",colour="gray50",fill="white")
mapWorld=ggplot()+worldmap
...
gganimate(Grap_map,interval=3.5,"output.html")
#interval is in seconds
```
